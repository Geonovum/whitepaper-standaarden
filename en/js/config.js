var respecConfig = {
  ...
  localBiblio: {
    ...
    "WFS-NL": {
      ...
      title:
        "Nederlands profiel op ISO 19142 Geographic information — Web Feature Service",
      authors: ["Geonovum"],
      date: "24 april 2015",
    },
    WFS: {
    ...
    GeoPackage: {
      href: "http://www.opengeospatial.org/standards/geopackage",
      publisher: "OGC",
      authors: ["Jeff Yutzler"],
      date: "4 August 2015",
    ...
    topic20: {
      ...
      status: "OGC Abstract Specification",
    },
    "3dps": {
      href: "https://portal.opengeospatial.org/files/65620",
      publisher: "OGC",
      authors: ["Benjamin Hagedorn", "Simon Thum"],
      date: "27 August 2015",
      title: "3D Portrayal Service Standard 1.0",
      status: "Public comment draft",
    },
    citygml20: {
      href: "http://www.opengeospatial.org/standards/citygml",
      publisher: "OGC",
      authors: [
        "Gerhard Gröger",
        "Thomas H. Kolbe",
      ...
      status: " OpenGIS Encoding Standard",
    },
    GeoSPARQL: {
